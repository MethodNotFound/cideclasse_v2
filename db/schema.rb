...
ActiveRecord::Schema[7.2].define(version: 2024_11_04_142527) do
  ...
  create_table "active_storage_data", force: :cascade do |t|
    ...
    t.index ["key"], name: "index_active_storage_data_on_key", unique: true
  end
  ...
  create_table "klasses_students", id: false, force: :cascade do |t|
    ...
    t.index ["klass_id"], name: "index_klasses_students_on_klass_id"
    t.index ["student_id"], name: "index_klasses_students_on_student_id"
  end

  create_table "klasses_tasks", id: false, force: :cascade do |t|
    t.bigint "klass_id", null: false
    t.bigint "task_id", null: false
    t.index ["klass_id"], name: "index_klasses_tasks_on_klass_id"
